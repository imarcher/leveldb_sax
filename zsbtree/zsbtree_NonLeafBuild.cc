...
inline int get_new_end(newVector<NonLeafKey> &leafKeys, int l, int r, saxt saxt_, cod co_d) {
  while(l < r)
  {
    int mid = (l + r)/ 2;
...
inline int get_new_end_1(newVector<NonLeafKey> &leafKeys, int l, int r, saxt saxt_, cod co_d) {
  while(l < r)
  {
    int mid = (l + r + 1)/ 2;
